...
class FacetsWithEntryPoint(FacetConstants):
    ...
    @classmethod
    def from_request(
            cls, library, facet_config, get_argument, worklist,
        ...
        return cls._from_request(
            facet_config, get_argument, worklist,
            default_entrypoint, **extra_kwargs
        )

    @classmethod
    def _from_request(
            cls, facet_config, get_argument, worklist,
            default_entrypoint=None, **extra_kwargs
    ):
        """Load a faceting object from an HTTP request.
...
class Facets(FacetsWithEntryPoint):
    ...
    @classmethod
    def from_request(cls, library, config, get_argument, worklist,
        ...
        return cls._from_request(config, get_argument, worklist,
